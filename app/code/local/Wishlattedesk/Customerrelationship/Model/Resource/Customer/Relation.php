 ...
 */
class Wishlattedesk_Customerrelationship_Model_Resource_Customer_Relation extends Mage_Core_Model_Resource_Db_Abstract
{
    public function _construct()
    {
        $this->_init('customerrelationship/customer_relation', 'id');
    }
}